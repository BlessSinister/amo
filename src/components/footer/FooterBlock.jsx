  ...
  return (
    <footer className={style.container}>
      <div className={style.company}>
        ...
        <p className={style.desription}>Партнёрская программа</p>
        <p className={style.desription}>Вакансии</p>
      </div>
      <div className={style.block2_wrapper}>
        <div className={style.menu}>
          <p className={style.title}>Меню</p>
          <p className={style.desription}>Расчёт стоимости</p>
          <p className={style.desription}>Услуги</p>
          <p className={style.desription}>Виджеты</p>
          <p className={style.desription}>Интеграции</p>
          <p className={style.desription}>Наши клиенты</p>
        </div>
        <div className={style.menu}>
          <p className={style.desription} style={{ marginTop: '3.7rem' }}>
            Благодарность клиентов
          </p>
          <p className={style.desription}>Кейсы</p>
          <p className={style.desription}>Сертификаты</p>
          <p className={style.desription}>Блог на Youtube</p>
          <p className={style.desription}>Вопрос / Ответ</p>
        </div>
      </div>
      <div className={style.contacts}>
        <p className={style.title}>Контакты</p>
        <p className={style.desription}>+7 555 555-55-55</p>
        <svg
        ...
        <p className={style.desription}>Москва, Путевой проезд 3с1, к 902</p>
        <p className={`${style.copyrights} ${style.margin_copy}`}>
          ©WELBEX 2022. Все права защищены.
        </p>
        <p
          className={style.copyrights}
